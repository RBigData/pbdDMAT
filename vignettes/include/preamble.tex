...
\lstdefinelanguage{fanC}{
	...
	captionpos=t,
	morecomment=[l]{//},
	morekeywords={newRvec,newRlist, newRmat, R_INIT, PT, R_END, INTP, DBLP, 
INT, DBL, STR, MatINT, matDBL, RNULL, is_null, is_Rnull, is_Rnan, is_Rna, 
is_double, is_integer, PRINT}
}
