...
the object \code{dmat_opts$BLDIM}.  So for example, if the user wishes to have a 
...
changing the value of the object \code{dmat_opts$ICTXT}.  So if the user wishes 
